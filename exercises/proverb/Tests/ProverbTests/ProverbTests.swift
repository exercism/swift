...
class ProverbTests: XCTestCase {
    ...
    var proverb: ProverbExample!

    override func setUp() {
        super.setUp()

        proverb = ProverbExample()
    ...
    func testZeroPiecesOfProverb() {
        ...
        let actualResult = proverb.recite(pieces: [])
    ...
    func testOnePieceOfProverb() {
        ...
        let actualResult = proverb.recite(pieces: ["nail"])
        XCTAssertEqual(expectedResult, actualResult)
    }
    ...
    func testTwoPiecesOfProverb() {
        ...
        let actualResult = proverb.recite(pieces: ["nail", "shoe"])
        XCTAssertEqual(expectedResult, actualResult)
    }
    ...
    func testThreePiecesOfProverb() {
        ...
        let actualResult = proverb.recite(pieces: ["nail", "shoe", "horse"])
        XCTAssertEqual(expectedResult, actualResult)
    ...
    func testFullProverb() {
        ...
        let actualResult = proverb.recite(pieces: ["nail", "shoe", "horse", "rider", "message", "battle", "kingdom"])
        XCTAssertEqual(expectedResult, actualResult)
    }
    ...
    func testFourPiecesOfProverbModernized() {
        ...
        let actualResult = proverb.recite(pieces: ["pin", "gun", "soldier", "battle"])
        XCTAssertEqual(expectedResult, actualResult)
    }
