...
warn("Please provide a summary in the Pull Request description. See http://tinyletter.com/exercism/letters/exercism-pull-requests") if github.pr_body.length < 5
